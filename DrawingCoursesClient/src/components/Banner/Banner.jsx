...
const Banner = () => {
  return (
    <main className="banner-image" id="banners-section" style={{ height: "40rem" }}>
      <div className="relative px-6 lg:px-8">
        <div className="mx-auto max-w-5xl pt-16 sm:pt-40 sm:pb-24">
          <div className="text-center">
            <h1
              className="text-4xl font-bold tracking-tight text-gray-900 sm:text-75px md:4px"
              style={{ color: "white" }}
            >
              Advance your drawing <br /> skills with our courses
            </h1>
            <p

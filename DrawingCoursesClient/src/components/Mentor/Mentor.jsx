...
const Mentor = () => {
    return (
            ...
            <div id="mentors-section" className="mx-auto max-w-2xl pb-16 px-4 sm:py-16 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <div className='sm:flex justify-between items-center mb-12'>
                    ...
                    <div>
                    <Link to="/Mentor" type="button" className='bg-transparent hover:bg-purple text-purple font-medium hover:text-white py-3 px-4 border border-lightgrey hover:border-transparent rounded'>Explore 10+ Mentors</Link>
                    </div>
                </div>
